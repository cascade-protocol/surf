...
|---------|--------|-------|----------|
| **Inference** - LLM chat completions (GLM-5, Claude, Grok 4.1 Fast, Kimi K2.5, MiniMax M2.5, Qwen 2.5 7B) | `inference.surf.cascade.fyi` | $0.001-0.23 | Solana, Base |
...
| **Web** - Crawl pages, search via Exa | `web.surf.cascade.fyi` | $0.002-0.01 | Solana, Base |
